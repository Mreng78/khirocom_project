...
import "package:frontend/Screens/assistscreen/UnderDevelopmentScreen.dart";
                                ...
                                : () async {
                                    if (formKey.currentState!.validate()) {
                                      ...
                                      if (isSuccess) {
                                        ...
                                        if (error.contains("الاتصال بالسيرفر") || error.contains("Server error")) {
                                          _showErrorDialog(
                                            icon: Icons.network_check,
                                            title: "خطأ أثناء محاولة الاتصال بالخادم",
                                            subtitle: "تأكد من اتصالك بالانترنت",
                                          );
                                        } else {
                                          _showErrorDialog(
