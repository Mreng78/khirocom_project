...
class Student {
  ...
  factory Student.fromJson(Map<String, dynamic> json) => Student(
        ...
        stopDate: json['stopDate'] != null ? (json['stopDate'] is String ? DateTime.parse(json['stopDate']) : json['stopDate']) : null,
        stopReason: json['stopReason']?.toString() ?? '',
        DismissedDate: json['DismissedDate'] != null ? (json['DismissedDate'] is String ? DateTime.parse(json['DismissedDate']) : json['DismissedDate']) : null,
        DismissedReason: json['DismissedReason']?.toString() ?? '',
        ...
        HalakatId: json['HalakatId'] is int ? json['HalakatId'] : int.tryParse(json['HalakatId']?.toString() ?? "0") ?? 0,
        current_Revision_Sorah: json['current_Revision_Sorah']?.toString() ?? '',
        current_Revision_Aya: json['current_Revision_Aya']?.toString() ?? '',
        total_Revision_Cycles: json['total_Revision_Cycles'] is int ? json['total_Revision_Cycles'] : int.tryParse(json['total_Revision_Cycles']?.toString() ?? "0") ?? 0,
